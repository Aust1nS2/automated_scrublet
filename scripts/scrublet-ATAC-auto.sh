...
# must be run in conda environment containg python, pandas, numpy, scipy.io, matplotlib, random, sklearn.cluster
#Example command call: bash scrublet-ATAC-auto.sh /diskmnt/Projects/Users/austins2/tools/automated_scrublet/scripts /diskmnt/Projects/PDX_scRNA_analysis/matching_snRNAseq/PDAC/cellranger-arc2
...
for dir in $cellrangerpath/*; do
    ...
    then
        ...
        then
            ...
            mkdir $outdir/$dir
            cd $outdir/$dir
            python3 $scrublet/scrublet-comboATAC-auto.py -s $dir -c $cellrangerpath/$dir -u 0.2 $outdir
            cd $folder
        else
