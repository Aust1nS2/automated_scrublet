...
# Reyka Jayasinghe wrote stuff to read input 
# Austin Southard-smith modified for ATAC data and wrote the rest
...
input_dir=cellranger+"/outs/filtered_peak_bc_matrix/"
